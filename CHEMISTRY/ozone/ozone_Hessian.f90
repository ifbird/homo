...
! Compute the vector HTU =(Hess x U2)^T * U1 = d (Jac^T*U1)/d Var * U2
  HTU(1) = HESS(1)*(U1(1)*U2(2))+HESS(2)*(U1(2)*U2(2))
  HTU(2) = HESS(1)*(U1(1)*U2(1))+HESS(2)*(U1(2)*U2(1))
